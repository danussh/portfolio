            ...
            <Card>
              ...
              <div>
                <Card.Title className="text-center">
                  <b>PROGRAMMER ANALYST TRAINEE</b>
                </Card.Title>
              </div>
              <div>
                <Card.Text className="text-center style">
                  ...
                  <ul className="text-left">
                    <li>
                      <strong>Develop </strong> & Code high-performance programs
                      for Clients
                    </li>
                    <li>
                      <strong>Analyze</strong> user needs and design software
                      solutions
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Perform</strong> Work with other teams for
                      debugging.
                    </li>
                  </ul>
                </Card.Text>
